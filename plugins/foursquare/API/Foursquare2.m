...
+ (void)initialize
{
    ...
    NSMutableDictionary *dict = [[NSMutableDictionary alloc] initWithContentsOfFile:PREFS];
    
    if ([dict objectForKey:@"access_token"] != nil)
        [[self classAttributes] setObject:[dict objectForKey:@"access_token"] forKey:@"access_token"];
    [dict release];
}
