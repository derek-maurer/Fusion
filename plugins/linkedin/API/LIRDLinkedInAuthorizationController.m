...
#import "LIRDLinkedInAuthorizationController.h"
#import "LIRDLinkedInEngine.h"
#import "LIRDLogging.h"


@interface LIRDLinkedInAuthorizationController ()
...
@implementation LIRDLinkedInAuthorizationController
...
- (id)initWithConsumerKey:(NSString *)consumerKey consumerSecret:(NSString *)consumerSecret delegate:(id<LIRDLinkedInAuthorizationControllerDelegate>)delegate {
  return [self initWithEngine:[LIRDLinkedInEngine engineWithConsumerKey:consumerKey consumerSecret:consumerSecret delegate:nil] delegate:delegate];
}
