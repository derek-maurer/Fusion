...
- (id)init {
    if ((self = [super initWithFrame:CGRectZero])) {
        ...
        UIImage* closeImage = [UIImage imageWithContentsOfFile:@"/Library/Application Support/Fusion/Plugins/FacebookPlugin.bundle/FacebookPluginPrefs.bundle/close.png"];
